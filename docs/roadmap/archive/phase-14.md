...
- [x] 将 BrightnessService 的 IOKit 调用移到后台线程
  - 实现提示：
...
- [x] 将 DisplayInfo.init 的 IOKit 查询移到后台
  - 实现提示：
...
- [x] 将 ColorProfileService.enumerateProfiles 改为异步
  - 实现提示：
...
- [x] 拆分 DisplayInfo 的 @Published 属性，减少级联重绘
  - 实现提示：
