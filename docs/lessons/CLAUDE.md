...
| 主题 | 文件 | 条数 |
|------|------|------|
| IOKit / DDC / 旋转 / 环境光 / 显示器匹配 / Apple Silicon | [iokit.md](iokit.md) | L-003, L-004, L-005, L-028 ~ L-035 + 通用条目 |
| CoreGraphics / HiDPI / CGVirtualDisplay | [coregraphics.md](coregraphics.md) | L-006, L-007, L-020 ~ L-027, L-035, L-036 + 通用条目 |
